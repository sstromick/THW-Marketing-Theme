...
if (!empty($email)) {
	$detailsHtml .= '<p>If you’d like to have a chat with us about your social media marketing challenges or needs, please drop us a line. You can email us on <a href="mailto:' . $email . '" target="_blank" itemprop="email">' . $email . '</a> or easily send us a message by filling out the form provided here, and we will get back with you shortly. </p><p>If you’d like to discuss having Teresa as a speaker at your next event, please do fill out the form here or email us on <a href="mailto:' . $email . '" target="_blank" itemprop="email">' . $email . '</a>. In the body of your message, please let us know the date(s) of your event. We will then be in touch with you to discuss further details.</p>';
}
